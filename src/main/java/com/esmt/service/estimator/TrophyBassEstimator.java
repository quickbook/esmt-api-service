...
public class TrophyBassEstimator extends BaseNewPondQuoteEstimator {
	
	@Autowired
	QuoteConfigService configService;

	protected TrophyBassEstimator(QuotePackageRepository packageRepo, PackageFishCompositionRepository compositionRepo,
