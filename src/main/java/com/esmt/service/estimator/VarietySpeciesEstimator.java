...
@Service
public class VarietySpeciesEstimator extends BaseNewPondQuoteEstimator {
	
	@Autowired
	QuoteConfigService configService;

	protected VarietySpeciesEstimator(QuotePackageRepository packageRepo, PackageFishCompositionRepository compositionRepo,
