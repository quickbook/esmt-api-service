...
@Service
public class QualityBassBreamEstimator extends BaseNewPondQuoteEstimator {
	
	@Autowired
	QuoteConfigService configService;

	protected QualityBassBreamEstimator(QuotePackageRepository packageRepo, PackageFishCompositionRepository compositionRepo,
